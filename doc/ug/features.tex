...
\item \newfeature{LANGEVIN\_Z\_ONLY} Thermostats movement in the Z direction 
 only. Requires the langevin thermostat to be set. This feature has not yet been
 used for any serious application.
\item \newfeature{LEES\_EDWARDS} Permits the application of shear strain to the 
 system by moving boundary conditions. 
