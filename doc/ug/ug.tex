...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\DeclareRobustCommand{\es}{\mbox{\textsf{ESPResSo}}\xspace}
...
\DeclareRobustCommand{\warning}[1]{
  \begin{center}%
...
\DeclareRobustCommand*{\mainindex}[1]{\textbf{\hyperpage{#1}}}
...
\DeclareRobustCommand{\citewbibkey}[1]{%
  \cite{#1} (\textsc{BibTeX}-key \texttt{#1} in file \texttt{doc/ug/citations.bib})}
...
% keywords/literals
\DeclareRobustCommand{\lit}[1]{\mbox{\texttt{#1}}}
\DeclareRobustCommand{\keyword}[1]{\mbox{\texttt{#1}}}
% variables
\DeclareRobustCommand{\var}[1]{\ensuremath{\mathrm{\mathit{#1}}}}
% option
\DeclareRobustCommand{\opt}[1]{\mbox{\textrm{[}#1\textrm{]}}}
\DeclareRobustCommand{\optlong}[1]{\textrm{[}#1\textrm{]}}
% alternatives
\DeclareRobustCommand{\alt}[1]{\textrm{(} #1 \textrm{)}}
\DeclareRobustCommand{\asep}{$|$\xspace}
% variant
% \rawvariant is required, as the command is changed during the
% essyntax environment
\DeclareRobustCommand{\rawvariant}[1]{\mbox{\textnormal{(#1)}}\xspace}
\DeclareRobustCommand{\variant}[1]{\rawvariant{#1}}
\DeclareRobustCommand{\fmark}[1]{%
  \raisebox{1ex}{%
    \textrm{\footnotesize #1}%
  }%
}
% feature
%\DeclareRobustCommand{\feature}[1]{\texttt{\MakeUppercase{#1}}}
\DeclareRobustCommand{\feature}[1]{\texttt{\MakeUppercase{#1}}}

\DeclareRobustCommand{\require}[2]{%
  \mbox{#2\,\fmark{#1}}%
}
\DeclareRobustCommand{\required}[2][]{%
...
\DeclareRobustCommand{\analyzeindex}[1]{%
  \index{#1|mainindex}%
