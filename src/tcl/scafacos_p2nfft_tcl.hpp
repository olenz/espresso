...
#ifndef _TCL_SCAFACOS_P2NFFT_TCL_H
#define _TCL_SCAFACOS_P2NFFT_TCL_H
...
int tclcommand_inter_coulomb_parse_scafacos_p2nfft_tune(Tcl_Interp * interp, int argc, char ** argv, int adaptive);
