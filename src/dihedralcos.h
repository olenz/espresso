...
MDINLINE int dihedralcos_set_params(int bond_type, double bend, double bend1, double bend2)
{
  if(bond_type < 0)
    return ES_ERROR;
...
MDINLINE void calc_dihedralcos_angle(Particle *p1, Particle *p2, Particle *p3, Particle *p4, 
...
*/
MDINLINE int calc_dihedralcos_force(Particle *p2, Particle *p1, Particle *p3, Particle *p4,
...
/** calculate dihedral energy between particles p1, p2 p3 and p4 
    Written by Arijit Maitra, adapted to new force interface by Hanjo */
MDINLINE int dihedralcos_energy(Particle *p1, Particle *p2, Particle *p3, Particle *p4,
