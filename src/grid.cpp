...
#ifdef LEES_EDWARDS
  node_neighbors     = static_cast<int*>(realloc(node_neighbors, 6 * sizeof(int)));
  node_neighbor_lr   = static_cast<int*>(realloc(node_neighbor_lr, 6 * sizeof(int)));
  node_neighbor_wrap = static_cast<int*>(realloc(node_neighbor_wrap, 6 * sizeof(int)));
#endif  
  ...
  neighbor_count = 6;
   ...
   if( boundary[2] == 1 || boundary[3] == -1 ){
      ...
      if( ( boundary[2] == 1 && boundary[3] != -1) || ( boundary[3] == -1 && boundary[2] != 1) ){
        node_neighbors      = static_cast<int*>(realloc(node_neighbors, (neighbor_count + node_grid[0] - 1)*sizeof(int)));
        node_neighbor_lr    = static_cast<int*>(realloc(node_neighbor_lr, (neighbor_count + node_grid[0] - 1)*sizeof(int)));
        node_neighbor_wrap  = static_cast<int*>(realloc(node_neighbor_wrap, (neighbor_count + node_grid[0] - 1)*sizeof(int))); 
      }else if( boundary[3] == -1 && boundary[2] == 1){
        node_neighbors      = static_cast<int*>(realloc(node_neighbors, (neighbor_count + 2 * node_grid[0] - 2)*sizeof(int)));
        node_neighbor_lr    = static_cast<int*>(realloc(node_neighbor_lr, (neighbor_count + 2 * node_grid[0] - 2)*sizeof(int)));
        node_neighbor_wrap  = static_cast<int*>(realloc(node_neighbor_wrap, (neighbor_count + 2 * node_grid[0] - 2)*sizeof(int))); 
      }
